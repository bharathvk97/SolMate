<?php $__env->startSection('title', 'Add New Mess'); ?>
...
<div style="display:flex;min-height:calc(100vh - 65px);">
  <aside style="width:240px;background:var(--bg-surface);border-right:1px solid var(--border-color);position:sticky;top:65px;height:calc(100vh - 65px);overflow-y:auto;flex-shrink:0;">
    <div class="pt-3">
      ...
      <a href="<?php echo e(route('owner.mess.dashboard')); ?>" class="sidebar-item"><i class="bi bi-speedometer2"></i> Overview</a>
      <a href="<?php echo e(route('owner.mess.create')); ?>" class="sidebar-item active"><i class="bi bi-plus-circle"></i> Add Mess</a>
      <a href="<?php echo e(route('owner.mess.bookings')); ?>" class="sidebar-item"><i class="bi bi-calendar-check"></i> Subscribers</a>
      <div class="sidebar-section-label">Account</div>
      <a href="<?php echo e(route('owner.subscription')); ?>" class="sidebar-item"><i class="bi bi-credit-card"></i> Subscription</a>
    </div>
  </aside>
  ...
  <div style="flex:1;padding:2rem;max-width:800px;">
    ...
    <form id="messForm" onsubmit="submitMess(event)">
      ...
      <div style="background:var(--bg-surface);border:1px solid var(--border-color);border-radius:14px;padding:1.5rem;margin-bottom:1.25rem;">
        ...
        <?php $__currentLoopData = [['morning','☀️','07:00','09:30'],['afternoon','🌤️','12:00','14:30'],['evening','🌅','16:00','18:00'],['night','🌙','19:00','21:30']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$slot,$icon,$defOpen,$defClose]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;padding:.6rem 0;border-bottom:1px solid var(--border-color);">
          <label style="display:flex;align-items:center;gap:6px;width:130px;cursor:pointer;">
            <input type="checkbox" name="<?php echo e($slot); ?>_enabled" value="1" checked style="accent-color:var(--brand-primary);">
            <span><?php echo e($icon); ?> <?php echo e(ucfirst($slot)); ?></span>
          </label>
          <div style="display:flex;align-items:center;gap:8px;flex:1;">
            <input type="time" name="<?php echo e($slot); ?>_open"  class="form-control" value="<?php echo e($defOpen); ?>"  style="max-width:120px;">
            <span style="color:var(--text-muted);">to</span>
            <input type="time" name="<?php echo e($slot); ?>_close" class="form-control" value="<?php echo e($defClose); ?>" style="max-width:120px;">
          </div>
        </div>
      ...
      <div class="d-flex gap-3">
        <a href="<?php echo e(route('owner.mess.dashboard')); ?>" class="btn-outline-findr">Cancel</a>
...
function submitMess(e) {
  ...
  axios.post('/api/v1/owner/messes', fd, { headers:{'Content-Type':'multipart/form-data'} })
    .then(() => { showToast('Mess submitted for review!','success'); setTimeout(() => window.location='<?php echo e(route("owner.mess.dashboard")); ?>', 1500); })
    .catch(err => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\SolmateProject\hostel-mess-finder\laravel\resources\views/owner/mess/create.blade.php ENDPATH**/ ?>