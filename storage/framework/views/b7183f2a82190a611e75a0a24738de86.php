...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Hostel & Mess Finder'); ?> — SolMate</title>
    ...
    <div class="container-fluid px-4">
        <div class="d-flex align-items-center justify-content-between" style="height:65px;">
            ...
            <div class="d-none d-md-flex align-items-center gap-1">
                ...
                <a href="<?php echo e(route('hostels.index')); ?>" class="nav-link <?php echo e(request()->routeIs('hostels.*') ? 'active' : ''); ?>">
                    <i class="bi bi-building me-1"></i>Hostels
                </a>
                <a href="<?php echo e(route('messes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('messes.*') ? 'active' : ''); ?>">
            ...
            <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" style="background:var(--bg-surface); border-color:var(--border-color); border-radius:12px; box-shadow:var(--card-shadow); min-width:200px;">
                            <li class="px-3 py-2">
                                ...
                                <p style="font-weight:600; color:var(--text-primary); font-size:0.88rem; margin:0;"><?php echo e(auth()->user()->email); ?></p>
                            </li>
                            <li><hr style="border-color:var(--border-color); margin:4px 0;"></li>
                            <?php if(auth()->user()->isAdmin()): ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>" style="color:var(--text-primary); border-radius:8px;"><i class="bi bi-speedometer2 me-2"></i>Admin Panel</a></li>
                            <?php elseif(auth()->user()->isHostelOwner()): ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('owner.hostel.dashboard')); ?>" style="color:var(--text-primary); border-radius:8px;"><i class="bi bi-grid me-2"></i>Dashboard</a></li>
                            <?php elseif(auth()->user()->isMessOwner()): ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('owner.mess.dashboard')); ?>" style="color:var(--text-primary); border-radius:8px;"><i class="bi bi-grid me-2"></i>Dashboard</a></li>
                            <?php else: ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('user.bookings')); ?>" style="color:var(--text-primary); border-radius:8px;"><i class="bi bi-calendar-check me-2"></i>My Bookings</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('user.favourites')); ?>" style="color:var(--text-primary); border-radius:8px;"><i class="bi bi-heart me-2"></i>Favourites</a></li>
                            <?php endif; ?>
                            <li><a class="dropdown-item" href="<?php echo e(route('profile')); ?>" style="color:var(--text-primary); border-radius:8px;"><i class="bi bi-person me-2"></i>Profile</a></li>
                            <li><hr style="border-color:var(--border-color); margin:4px 0;"></li>
                            <li>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-outline-findr d-none d-md-inline-flex align-items-center gap-1" style="padding: 0.45rem 1.1rem;">
                        Sign In
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="btn-primary-findr d-none d-md-inline-flex align-items-center gap-1" style="padding: 0.45rem 1.1rem;">
                        Get Started
                    </a>
                <?php endif; ?>
            </div>
...
<!-- ═══════════════ FOOTER ═══════════════ -->
<?php if (! (request()->routeIs('admin.*') || request()->routeIs('owner.*'))): ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-2">
                ...
                <ul style="list-style:none; padding:0;">
                    <li><a href="<?php echo e(route('hostels.index')); ?>" style="color:var(--text-secondary); font-size:0.88rem; display:block; padding:4px 0;">Hostels</a></li>
                    <li><a href="<?php echo e(route('messes.index')); ?>" style="color:var(--text-secondary); font-size:0.88rem; display:block; padding:4px 0;">Messes</a></li>
                </ul>
            </div>
            <div class="col-md-2">
                ...
                <ul style="list-style:none; padding:0;">
                    <li><a href="<?php echo e(route('register')); ?>" style="color:var(--text-secondary); font-size:0.88rem; display:block; padding:4px 0;">List Your Hostel</a></li>
                    <li><a href="<?php echo e(route('register')); ?>" style="color:var(--text-secondary); font-size:0.88rem; display:block; padding:4px 0;">List Your Mess</a></li>
                </ul>
            </div>
        </div>
        <hr style="border-color:var(--border-color); margin:2rem 0 1rem;">
        <p style="color:var(--text-muted); font-size:0.82rem; text-align:center;">&copy; <?php echo e(date('Y')); ?> SolMate All rights reserved.</p>
    </div>
</footer>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\SolmateProject\hostel-mess-finder\laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>