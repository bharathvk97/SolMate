...
<div class="auth-hero">
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('login') }}" id="loginForm">
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('password.forgot') }}" style="font-size:0.8rem; color:var(--brand-primary);">Forgot password?</a>
                </div>
                <div style="position:relative;">
                    ...
                    <input type="password" name="password" id="pwdField" class="form-control @error('password') is-invalid @enderror"
        ...
        <p style="text-align:center; font-size:0.88rem; color:var(--text-secondary); margin:0;">
            ...
            <a href="{{ route('register') }}" style="font-weight:600; color:var(--brand-primary);">Create account</a>
        </p>
    </div>
</div>
@endsection
