...
<div style="background:var(--bg-surface); border-bottom:1px solid var(--border-color);">
    <div class="container">
        <div class="row py-3 text-center">
            <div class="col-4">
                <strong style="font-size:1.2rem; color:var(--brand-primary);">{{ $stats['hostels'] ?? '50+' }}</strong>
            ...
            <div class="col-4" style="border-left:1px solid var(--border-color); border-right:1px solid var(--border-color);">
                <strong style="font-size:1.2rem; color:var(--brand-secondary);">{{ $stats['messes'] ?? '30+' }}</strong>
                <p style="font-size:0.78rem; color:var(--text-muted); margin:0;">Registered Messes</p>
            </div>
            <div class="col-4">
                <strong style="font-size:1.2rem; color:var(--brand-accent);">{{ $stats['cities'] ?? '5+' }}</strong>
                ...
                <div class="card-findr p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button onclick="setRating({{ $r }},this)" style="background:none;border:none;font-size:1.3rem;cursor:pointer;padding:2px;color:var(--text-muted);" title="{{ $r }} star+">★</button>
                            @endforeach
                        </div>
                    </div>
