...
<div class="owner-wrapper">
    ...
    <div class="owner-content">
            ...
            <div class="d-flex gap-3">
                ...
                <div style="flex:1;min-width:0;">
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        @if($review->is_verified)<span class="rev-verified">✓ Verified</span>@endif
                    ...
                    <div class="d-flex align-items-center gap-2 mt-1 flex-wrap">
                        ...
                        <span class="rev-listing"><i class="bi bi-egg-fried"></i> {{ $review->reviewable?->name ?? 'Deleted listing' }}</span>
                    </div>
                    ...
                    <details class="rev-reply-form">
                        ...
                        <form method="POST" action="{{ route('owner.mess.reviews.reply', $review->id) }}" style="margin-top:0.6rem;">
                            @csrf
        ...
        <div class="card-findr p-5 text-center" style="color:var(--text-muted);">
            ...
            <p style="font-size:.88rem;">When diners review your messes, their feedback will appear here.</p>
        </div>
        @endforelse
